...
Clone Repository và Cài Đặt Fiamma
git clone https://github.com/fiamma-chain/fiamma.git
cd fiamma
git checkout v0.2.1
make install

4. Khởi Tạo Thư Mục Node
...
6. Cập Nhật Cấu Hình Peers và Seed Nodes
...
8. Cài Đặt và Cấu Hình Cosmovisor
...
Tạo dịch vụ hệ thống cho Cosmovisor:
